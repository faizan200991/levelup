                   ...
                   <div className="absolute top-12 right-12 space-y-3">
                      {[1, 2, 3, 4].map(i => (
                        <motion.div 
                          ...
                          className="px-4 py-2 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl text-[8px] font-black uppercase text-zinc-500 tracking-[0.2em]"
                        >
                          Node_{i * 255}_Active
                        </motion.div>
                      ))}
                      ...
                      >
                         <div className="flex items-center justify-between">
                            ...
                            <div className="text-right">
                               <p className="text-[10px] font-mono text-zinc-400 uppercase">Latency</p>
    ...
    <div className="p-12 rounded-[3.5rem] bg-white border border-zinc-100 shadow-sm hover:shadow-2xl transition-all duration-700 group">
      ...
      <div className="flex items-center gap-6">
        ...
        <div>
          ...
          <p className="text-[10px] text-zinc-400 font-black uppercase tracking-widest">{role}</p>
        </div>
      </div>
    </div>
  );
